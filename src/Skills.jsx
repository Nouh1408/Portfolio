...
export default function Skills() {
  return (
    <section className="w-full py-8 flex flex-col justify-center relative">
      {/* Background Glows */}
      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            A combination of modern frameworks, robust languages, and powerful
        ...
        <div className="flex flex-col gap-16 items-center">
          ...
          <div className="w-full">
            ...
            <div className="mt-16 p-8 bg-gradient-to-br from-emerald-500/5 to-cyan-500/5 border border-slate-700/50 hover:border-emerald-500/30 transition-colors rounded-3xl relative overflow-hidden group max-w-3xl mx-auto">
              ...
              <h4 className="text-xl font-bold text-white relative z-10 mb-3 text-center">
                Always Learning
              </h4>
              <p className="text-slate-400 relative z-10 text-sm leading-relaxed text-center">
                The tech landscape evolves rapidly. I spend my free time
                exploring new libraries, and building side projects to stay at
                the cutting edge.
              </p>
            </div>
          </div>
